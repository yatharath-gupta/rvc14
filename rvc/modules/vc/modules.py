...
class VC:
    ...
    def vc_inference(
        ...
        protect: float = 0.33,
        hubert_path5: str | None = None,
    ):
        hubert_path5 = os.getenv("hubert_path") if not hubert_path5 else hubert_path5

        # logger.warning("ERROR 655HEKKO " +hubert_path5 + "5212452532")
        try:
            ...
            if self.hubert_model is None:
                self.hubert_model = load_hubert(self.config, "hubert_base.pt")
            ...
            logger.warning("ERROR HEKKO " +info + "5212452532")
